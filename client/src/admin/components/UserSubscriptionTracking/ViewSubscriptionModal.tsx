      ...
      <div className="bg-white rounded-lg shadow-lg max-w-2xl w-full max-h-96 overflow-y-auto">
        ...
        <div className="sticky top-0 flex items-center justify-between px-6 py-4 border-b border-gray-200 bg-white">
          <h2 className="text-lg font-semibold text-gray-900">
            Chi tiết đăng ký #{subscription.subscription_id}
          </h2>
          <button
            onClick={onClose}
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-900">
                    {subscription.Subscription_Plan.monthly_ai_token_quota?.toLocaleString(
                      "vi-VN",
                    ) || 0}
                  </p>
                </div>
                {subscription.Subscription_Plan.features &&
                  Array.isArray(subscription.Subscription_Plan.features) && (
                    <div className="col-span-2">
                      <p className="text-xs text-gray-600 mb-2">Tính năng:</p>
                      <div className="grid grid-cols-2 gap-1">
                        {subscription.Subscription_Plan.features.map(
                          (feature, idx) => (
