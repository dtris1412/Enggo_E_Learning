      ...
      <div className="min-h-screen bg-slate-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <button
            ...
            className="bg-violet-600 hover:bg-violet-700 text-white font-medium py-2 px-6 rounded-md transition-colors"
          >
            Quay lại danh sách
          </button>
        </div>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 mb-8">
              ...
              <div className="space-y-4">
                <button
                  onClick={() => navigate("/flashcards")}
                  className="w-full bg-violet-600 hover:bg-violet-700 text-white font-semibold py-4 px-6 rounded-xl transition-all transform hover:scale-105 flex items-center justify-center gap-3"
                >
            ...
            <div className="flex items-center justify-between text-white">
              <button
                ...
                className="flex items-center gap-2 hover:text-violet-300 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="perspective-1000">
            ...
            >
              ...
              {/* Back Side */}
              <div
                className={`absolute inset-0 bg-gradient-to-br from-violet-800 to-violet-900 rounded-2xl shadow-2xl p-8 backface-hidden rotate-y-180 ${
