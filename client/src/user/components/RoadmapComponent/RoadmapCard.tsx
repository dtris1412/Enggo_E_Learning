  ...
  return (
    ...
    >
      <div className="p-6">
        ...
        {/* Title */}
        <h3 className="text-xl font-black text-slate-900 mb-3 line-clamp-2 min-h-[3.5rem] group-hover:text-blue-600 transition-colors">
        ...
        {/* CTA */}
        <button className="w-full bg-gradient-to-r from-amber-400 to-orange-500 text-slate-900 py-3 rounded-xl font-bold hover:shadow-md transition-all flex items-center justify-center gap-2">
